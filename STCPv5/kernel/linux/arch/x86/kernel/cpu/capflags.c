...
const char * const x86_cap_flags[NCAPINTS*32] = {
	...
	[X86_FEATURE_SM2]		 = "sm2",
	[X86_FEATURE_SM2_EN]		 = "sm2_en",
	[X86_FEATURE_XSTORE]		 = "rng",
	[X86_FEATURE_XSTORE_EN]		 = "rng_en",
	[X86_FEATURE_CCS]		 = "ccs",
	[X86_FEATURE_CCS_EN]		 = "ccs_en",
	...
	[X86_FEATURE_RNG2]		 = "rng2",
	[X86_FEATURE_RNG2_EN]		 = "rng2_en",
	[X86_FEATURE_PHE2]		 = "phe2",
	[X86_FEATURE_PHE2_EN]		 = "phe2_en",
	[X86_FEATURE_RSA]		 = "rsa",
	[X86_FEATURE_RSA_EN]		 = "rsa_en",
	...
	[X86_FEATURE_LASS]		 = "lass",
	[X86_FEATURE_FRED]		 = "fred",
	[X86_FEATURE_LAM]		 = "lam",
	...
	[X86_FEATURE_SEV_SNP]		 = "sev_snp",
	[X86_FEATURE_DEBUG_SWAP]	 = "debug_swap",
	[X86_FEATURE_SVSM]		 = "svsm",
	[X86_FEATURE_AMD_LBR_PMC_FREEZE] = "amd_lbr_pmc_freeze",
};
...
const char * const x86_bug_flags[NBUGINTS*32] = {
	...
	[X86_BUG_BHI - NCAPINTS*32]		 = "bhi",
	[X86_BUG_IBPB_NO_RET - NCAPINTS*32]	 = "ibpb_no_ret",
	[X86_BUG_SPECTRE_V2_USER - NCAPINTS*32]	 = "spectre_v2_user",
	[X86_BUG_OLD_MICROCODE - NCAPINTS*32]	 = "old_microcode",
	[X86_BUG_ITS - NCAPINTS*32]		 = "its",
	[X86_BUG_ITS_NATIVE_ONLY - NCAPINTS*32]	 = "its_native_only",
	[X86_BUG_TSA - NCAPINTS*32]		 = "tsa",
	[X86_BUG_VMSCAPE - NCAPINTS*32]		 = "vmscape",
	[X86_BUG_SEAMRET_INVD_VMCS - NCAPINTS*32] = "seamret_invd_vmcs",
};
...
const char * const x86_vmx_flags[NVMXINTS*32] = {
	...
	[VMX_FEATURE_EPT_5LEVEL]	 = "ept_5level",
	...
	[VMX_FEATURE_EPT_VIOLATION_VE]	 = "ept_violation_ve",
