...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_SOCKET_PRIORITY, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_MAX_SOCKETS, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_CONNECT_TIMEOUT_MS, 60000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_STCP_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETHERNET_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETHERNET_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ECHO_TRANSPORT_TCP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BENCH_CHUNK_SIZE, 16384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BENCH_FULL_RX_BUFFER_SIZE, 16384);
