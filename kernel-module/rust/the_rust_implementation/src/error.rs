...
// === Paxsudos IT / STCP kernel error codes ===
// Yleisimmät Linux error-arvot, Rust kernel -käyttöön.
// Lähde: include/uapi/asm-generic/error-base.h ja error.h
...
pub const EAGAIN:       i32 = 11;  // Try again / EWOULDBLOCK
...
// Laajennettu osa: yleisesti tarvittavat verkko-/STCP-tilanteissa
...
pub const EOVERFLOW:    i32 = 75;  // Value too large
...
pub const ELIBACC:      i32 = 79;  // Cannot access shared library
pub const ELIBBAD:      i32 = 80;  // Accessing corrupted shared library
...
pub const ERESTART:     i32 = 85;  // Interrupted sys call should be restarted
...
pub const ETOOMANYREFS: i32 = 109; // Too many references
...
pub const EKEYREJECTED: i32 = 129; // Key was rejected
pub const EOWNERDEAD:   i32 = 130; // Owner died
pub const ENOTRECOVERABLE: i32 = 131; // State not recoverable
pub const ERFKILL:      i32 = 132; // Operation blocked by RF-kill
...
impl StcpError {
    ...
    pub const fn error(self) -> i32 {
        match self {
            StcpError::Inval   => EINVAL,
            StcpError::Io      => EIO,
            StcpError::Proto   => EPROTO,
            StcpError::Crypto  => EIO,
            StcpError::NoMem   => ENOMEM,
            StcpError::MsgSize => EMSGSIZE,
            StcpError::Reset   => ECONNRESET,
        }
    }

    #[inline]
    pub const fn to_ret(self) -> c_int {
        -(self.error() as c_int)
    }
}

#[inline]
pub const fn neg(code: i32) -> c_int {
    -(code as c_int)
}

pub type Result<T> = core::result::Result<T, StcpError>;
