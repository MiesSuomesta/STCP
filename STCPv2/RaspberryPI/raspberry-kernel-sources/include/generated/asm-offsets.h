...
#define VCPU_FAULT_DISR 3672 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 3496 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
...
#define HOST_CONTEXT_VCPU 3200 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
...
#define CPU_CTX_SP 112 /* offsetof(struct cpu_suspend_ctx, sp) */
...
#define SLEEP_STACK_DATA_CALLEE_REGS 128 /* offsetof(struct sleep_stack_data, callee_saved_regs) */
