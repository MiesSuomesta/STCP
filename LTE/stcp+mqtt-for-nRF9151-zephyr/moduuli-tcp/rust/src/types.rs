...
// Tämä määrittely pitää olla, että tietää rust puoli kuinka iso strukti on
// Että tekee kopion transportille, ja käyttää kopiota.

// TÄTÄ EI SAA KÄYTTÄÄ MUUHUN ettei riko ajatusta että C ja RUST ei tiedä toisistaan
// mitään.
#[repr(C)]
#[derive(Clone, Debug)]
pub struct kernel_socket {
    pub fd: i32,
    pub kctx: *mut core::ffi::c_void,
}
