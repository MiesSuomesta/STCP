...
pub struct ContextInner {
    ...
    pub last_ack_sent: Option<u64>,
    pub last_nack_sent: Option<u64>,
    pub gap_frames_since_nack: u8,
    pub rx_frames_since_ack: u8,
...
pub struct StcpContext {
    pub proto: u8,
    /* 0 = idle, 1 = active, 2 = active with pending work. */
    pub parser_state: AtomicUsize,
...
impl StcpContext {
    pub fn new(proto: u8) -> Result<Self, crate::error::StcpError> {
        ...
        Ok(Self {
            proto,
            parser_state: AtomicUsize::new(0),
            inner: SpinLock::new(ContextInner {
                ...
                last_ack_sent: None,
                last_nack_sent: None,
                gap_frames_since_nack: 0,
                rx_frames_since_ack: 0,
                srtt_ms: None,
                rttvar_ms: 0,
                rto_ms: 300,
