...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_HOST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_PORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_PAYLOAD_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_TOTAL_BYTES, 1048576);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_TIMEOUT_MS, 30000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_WORKER_STACK_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_P2P_BENCH_WORKER_PRIORITY, 5);
