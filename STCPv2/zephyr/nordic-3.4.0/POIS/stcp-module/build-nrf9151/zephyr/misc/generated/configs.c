...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_IO_TIMEOUT_MS, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_CONNECT_TIMEOUT_MS, 60000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_LTE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_LTE_READY_TIMEOUT_SECONDS, 300);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_TEST_REMOTE_IPV4, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_TEST_REMOTE_PORT, 6677);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_TEST_MESSAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STCP_TEST_RECV_TIMEOUT_MS, 10000);
