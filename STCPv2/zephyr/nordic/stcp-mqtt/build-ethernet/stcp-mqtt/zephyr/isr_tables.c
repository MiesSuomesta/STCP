...
const uintptr_t __irq_vector_table _irq_vector_table[65] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x20016a80, (ISR)0x6270d}, /* 49 */
