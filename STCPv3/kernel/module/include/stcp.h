...
#define STCP_SO_COMPRESSION_LEVEL      4
#define STCP_COMPRESSION_DEFAULT_THRESHOLD 1024U
#define STCP_COMPRESSION_DEFAULT_LEVEL 3U

#define STCP_COMPRESSION_LEVEL_VERY_FAST 1
#define STCP_COMPRESSION_LEVEL_FAST      2
