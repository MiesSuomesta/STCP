...
#include <stcp/mqtt_transport_socket_stcp.h>
...
#if defined(CONFIG_MQTT_LIB_STCP)
	{
		mqtt_client_stcp_connect,
		mqtt_client_stcp_write,
		mqtt_client_stcp_write_msg,
		mqtt_client_stcp_read,
		mqtt_client_stcp_disconnect,
	},
