...
#define WDBGBIG(...)  _STCP_DO_CUSTOM_BIG_PRINT(WDBG, "%s", LOGTAG, "", ##__VA_ARGS__)
#define WWRNBIG(...)  _STCP_DO_CUSTOM_BIG_PRINT(WWRN, "%s", LOGTAG, "", ##__VA_ARGS__)
#define WINFBIG(...)  _STCP_DO_CUSTOM_BIG_PRINT(WINF, "%s", LOGTAG, "", ##__VA_ARGS__)
#define WERRBIG(...)  _STCP_DO_CUSTOM_BIG_PRINT(WERR, "%s", LOGTAG, "", ##__VA_ARGS__)
