...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x59325, (ISR)0x6457f}, /* 42 */
	...
	{(const void *)0x20020020, (ISR)0x62fe3}, /* 49 */
