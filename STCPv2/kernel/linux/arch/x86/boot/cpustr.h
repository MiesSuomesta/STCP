...
static const char x86_cap_strs[] =
...
#endif
#if REQUIRED_MASK5 & (1 << 0)
	"\x05\x00""sm2\0"
#endif
#if REQUIRED_MASK5 & (1 << 1)
	"\x05\x01""sm2_en\0"
#endif
	...
	"\x05\x03""rng_en\0"
#endif
#if REQUIRED_MASK5 & (1 << 4)
	"\x05\x04""ccs\0"
#endif
#if REQUIRED_MASK5 & (1 << 5)
	"\x05\x05""ccs_en\0"
#endif
	...
	"\x05\x0d""pmm_en\0"
#endif
#if REQUIRED_MASK5 & (1 << 22)
	"\x05\x16""rng2\0"
#endif
#if REQUIRED_MASK5 & (1 << 23)
	"\x05\x17""rng2_en\0"
#endif
#if REQUIRED_MASK5 & (1 << 25)
	"\x05\x19""phe2\0"
#endif
#if REQUIRED_MASK5 & (1 << 26)
	"\x05\x1a""phe2_en\0"
#endif
#if REQUIRED_MASK5 & (1 << 27)
	"\x05\x1b""rsa\0"
#endif
#if REQUIRED_MASK5 & (1 << 28)
	"\x05\x1c""rsa_en\0"
#endif
...
#endif
#if REQUIRED_MASK12 & (1 << 6)
	"\x0c\x06""lass\0"
#endif
#if REQUIRED_MASK12 & (1 << 17)
	"\x0c\x11""fred\0"
#endif
	...
	"\x13\x03""sev_es\0"
#endif
#if REQUIRED_MASK19 & (1 << 4)
	"\x13\x04""sev_snp\0"
#endif
#if REQUIRED_MASK19 & (1 << 14)
	"\x13\x0e""debug_swap\0"
#endif
#if REQUIRED_MASK19 & (1 << 28)
	"\x13\x1c""svsm\0"
#endif
#if REQUIRED_MASK21 & (1 << 0)
	"\x15\x00""amd_lbr_pmc_freeze\0"
#endif
	"\x15\x1f"""
	;
