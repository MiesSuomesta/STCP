...
static void raid6_int2_gen_syndrome(int disks, size_t bytes, void **ptrs)
{
	u8 **dptr = (u8 **)ptrs;
	u8 *p, *q;
	int d, z, z0;
...
static void raid6_int2_xor_syndrome(int disks, int start, int stop,
...
const struct raid6_calls raid6_intx2 = {
	.gen_syndrome	= raid6_int2_gen_syndrome,
	.xor_syndrome	= raid6_int2_xor_syndrome,
	.name		= "int" NSTRING "x2",
};
