...
pub use stcpcommon::defines_etc::StcpConnection;
...
#[no_mangle]
pub extern "C" fn stcp_client_connect(ip: *const c_char, port: u16) -> *mut std::ffi::c_void {
    if ip.is_null() {
        return ptr::null_mut();
    }
...
#[no_mangle]
pub extern "C" fn stcp_client_disconnect(client_ptr: *mut std::ffi::c_void) {
