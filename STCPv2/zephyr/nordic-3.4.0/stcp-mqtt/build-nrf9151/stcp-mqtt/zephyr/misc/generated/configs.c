...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WFA_QT_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZVFS_OPEN_ADD_SIZE_NRF_MODEM, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_ADD_SIZE_NRF9X_SOCKETS_GETADDRINFO, 192);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_MONITOR_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RRAM_WEAR_TEST_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RRAM_WEAR_TEST_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LINK_CONTROL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_ADD_SIZE_LTE_LINK_CONTROL, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_FUNCTIONAL_MODE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_NETWORK_REGISTRATION_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_CONNECTION_STATUS_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_SYSTEM_MODE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_DNS_FALLBACK_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_DNS_FALLBACK_ADDRESS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_ENV_EVAL_MAX_PLMN_COUNT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_WORKQUEUE_STACK_SIZE, 1280);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LINK_CONTROL_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LINK_CONTROL_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_ANTENNA_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TF_PSA_CRYPTO_CUSTOM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_T_COSE_PATH, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_TFM, 0x50000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_LIBRARY_SOURCE_NRFXLIB, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPU_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENTROPY_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_HEAP_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_BUF_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_LOAD_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZVFS_OPEN_ADD_SIZE_NET, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_USES_MAPPED_PARTITION, 1);
