...
#define SIZE_slim_device_id 16 /* sizeof(struct slim_device_id) */
#define OFF_slim_device_id_manf_id 0 /* offsetof(struct slim_device_id, manf_id) */
#define OFF_slim_device_id_prod_code 2 /* offsetof(struct slim_device_id, prod_code) */
...
#define SIZE_mcb_device_id 16 /* sizeof(struct mcb_device_id) */
#define OFF_mcb_device_id_device 0 /* offsetof(struct mcb_device_id, device) */
...
#define SIZE_cdx_device_id 20 /* sizeof(struct cdx_device_id) */
...
#define OFF_cdx_device_id_subvendor 4 /* offsetof(struct cdx_device_id, subvendor) */
#define OFF_cdx_device_id_subdevice 6 /* offsetof(struct cdx_device_id, subdevice) */
#define OFF_cdx_device_id_class 8 /* offsetof(struct cdx_device_id, class) */
#define OFF_cdx_device_id_class_mask 12 /* offsetof(struct cdx_device_id, class_mask) */
#define OFF_cdx_device_id_override_only 16 /* offsetof(struct cdx_device_id, override_only) */
#define SIZE_vchiq_device_id 32 /* sizeof(struct vchiq_device_id) */
#define OFF_vchiq_device_id_name 0 /* offsetof(struct vchiq_device_id, name) */
#define SIZE_coreboot_device_id 16 /* sizeof(struct coreboot_device_id) */
#define OFF_coreboot_device_id_tag 0 /* offsetof(struct coreboot_device_id, tag) */
